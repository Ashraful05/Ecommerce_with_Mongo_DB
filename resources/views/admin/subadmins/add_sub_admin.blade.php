...
@section('title','Add SubAdmin Page')
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form action="{{ route('save.sub.admin') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <img id="showImage" src="{{ url('admin/images/no_image.jpg') }}" style="height: 100px;width: 100px;" alt="">
                                    </div>
